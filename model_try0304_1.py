...
def detect(save_img=False):
    ...
    # 如果源是攝像頭，使用 cv2.VideoCapture
    if webcam or opt.source == '0':  # 假設 '0' 是使用本地攝像頭
        ...
        try:
            while True:
                ...
                if current_time >= next_inference_time:
                    ...
                    next_inference_time = current_time + 1  # 更新下一次推論時間
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default=r'C:/Users/ST/Desktop/Python/2.jpg', help='source')  # file/folder, 0 for webcam
